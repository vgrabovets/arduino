// shutter.h
//
/// \mainpage shutter library for Arduino
///
/// This is the Arduino shutter library.
...
///
/// shutter significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/shutter
/// The version of the package that this documentation refers to can be downloaded 
/// from http://www.airspayce.com/mikem/arduino/shutter/shutter-1.49.zip
///
/// Example Arduino programs are included to show the main modes of use.
///
/// You can also find online help and discussion at http://groups.google.com/group/shutter
...
/// with the exception that shutter uses steps per second rather than radians per second
...
///
/// \htmlonly <form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_donations" /> <input type="hidden" name="business" value="mikem@airspayce.com" /> <input type="hidden" name="lc" value="AU" /> <input type="hidden" name="item_name" value="Airspayce" /> <input type="hidden" name="item_number" value="shutter" /> <input type="hidden" name="currency_code" value="USD" /> <input type="hidden" name="bn" value="PP-DonationsBF:btn_donateCC_LG.gif:NonHosted" /> <input type="image" alt="PayPal — The safer, easier way to pay online." name="submit" src="https://www.paypalobjects.com/en_AU/i/btn/btn_donateCC_LG.gif" /> <img alt="" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1" border="0" /></form> \endhtmlonly
/// 
/// \par Trademarks
///
/// shutter is a trademark of AirSpayce Pty Ltd. The shutter mark was first used on April 26 2010 for
...
///               specifying shutter::FULL4WIRE and friends.
...
/// \version 1.43  Added DualMotorShield example. Shows how to use shutter to control 2 x 2 phase steppers using the 
...
///                Added new class MultiStepper that can manage multiple shutters, 
...
///                Added new method maxSpeed() to shutter to return the currently configured maxSpeed.<br>
...
// $Id: shutter.h,v 1.24 2015/10/04 05:16:38 mikem Exp mikem $
...
/////////////////////////////////////////////////////////////////////
/// \class shutter shutter.h <shutter.h>
...
/// shutter will not have a correct 
...
public:
    ...
    /// Use this in the pins argument the shutter constructor to 
    ...
    /// shutter::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// shutter::FULL2WIRE (2) means a 2 wire stepper (2 pins required). 
    /// shutter::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required). 
    /// shutter::FULL4WIRE (4) means a 4 wire stepper (4 pins required). 
    /// shutter::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// shutter::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to shutter::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a shutter::DRIVER (interface==1), 
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a shutter::DRIVER (interface==1), 
    ...
    shutter(unsigned short int up_sensor, unsigned short int down_sensor, uint8_t interface = shutter::FULL4WIRE, unsigned long max_time_to_run = 600000, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5, bool enable = true);
    ...
    shutter(void (*forward)(), void (*backward)());
...
private:
    ...
    /// The target position in steps. The shutter library will move the
	...
	/// Sensor positions
	unsigned short int _up_sensor;
	
	unsigned short int _down_sensor;
	
	unsigned long _max_time_to_run;
	
	bool fatal_error;
	
	unsigned long 	run_started;
...
/// Shows how to run shutter in the simplest,
...
/// Shows how to use shutter to control a 3-phase motor, such as a HDD spindle motor
/// using the Adafruit Motor Shield http://www.ladyada.net/make/mshield/index.html.

/// @example DualMotorShield.pde
/// Shows how to use shutter to control 2 x 2 phase steppers using the 
